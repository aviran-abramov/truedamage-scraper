...
const MATCH_URL =
  "https://www.gosugamers.net/counterstrike/tournaments/62664-cct-season-3-european-series-16/matches/640993-prime-vs-hyperspirit";
...
async function extractTeamData(teamContainer: Locator) {
  ...
  const rankText = await teamContainer.getByText("World Ranking").textContent();
